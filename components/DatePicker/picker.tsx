...
import { PickerProps, CalendarValue, ShortcutType, ModeType, DateInputHandle } from './interface';
...
const PickerComponent = forwardRef<DateInputHandle, InnerPickerProps>(Picker);
