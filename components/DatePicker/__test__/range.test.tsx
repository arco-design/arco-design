  ...
  it('hover placeholder', () => {
    ...
    expect(
      getInput(component, 0)
        .parent()
        .hasClass('arco-picker-input-active')
    ).toBeTruthy();
