...
|参数名|描述|类型|默认值|版本|
|---|---|---|---|---|
|content|当前面板的内容|`ReactNode` **(必填)**|`-`|2.27.0|
|size|分割的大小，可以是 0~1 代表百分比，或具体数值的像素，如 300px|`number \| string`|`-`|2.27.0|
|min|最小阈值，优先级比 `max`高，并且会影响相邻面板的阈值。|`number \| string`|`-`|2.27.0|
|max|最大阈值|`number \| string`|`-`|2.25.0|
